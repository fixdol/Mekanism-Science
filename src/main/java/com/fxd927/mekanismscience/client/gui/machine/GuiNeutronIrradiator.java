...
public class GuiNeutronIrradiator extends GuiConfigurableTile<TileEntityNeutronIrradiator, MekanismTileContainer<TileEntityNeutronIrradiator>> {
    public GuiNeutronIrradiator(MekanismTileContainer<TileEntityNeutronIrradiator> container, Inventory inv, Component title) {
