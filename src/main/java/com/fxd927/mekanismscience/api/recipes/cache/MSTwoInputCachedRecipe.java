...
public class MSTwoInputCachedRecipe<INPUT_A, INPUT_B, OUTPUT, RECIPE extends MekanismRecipe<?> & BiPredicate<INPUT_A, INPUT_B>> extends CachedRecipe<RECIPE> {
     ...
     */
    protected MSTwoInputCachedRecipe(RECIPE recipe, BooleanSupplier recheckAllErrors, IInputHandler<INPUT_A> inputHandler, IInputHandler<INPUT_B> secondaryInputHandler,
     ...
     * @param outputHandler        Output handler.
     */
    public static <RECIPE extends FluidChemicalToChemicalRecipe> MSTwoInputCachedRecipe<@NotNull FluidStack, @NotNull ChemicalStack, @NotNull ChemicalStack, RECIPE>
    fluidChemicalToChemical(RECIPE recipe, BooleanSupplier recheckAllErrors, IInputHandler<@NotNull FluidStack> fluidInputHandler,
        ...
        return new MSTwoInputCachedRecipe<>(recipe, recheckAllErrors, fluidInputHandler, chemicalInputHandler, outputHandler, recipe::getFluidInput,
     ...
     * @param outputHandler        Output handler.
     */
    public static <RECIPE extends ItemStackChemicalToItemStackRecipe> MSTwoInputCachedRecipe<@NotNull ItemStack, @NotNull ChemicalStack, @NotNull ItemStack, RECIPE>
    itemChemicalToItem(RECIPE recipe, BooleanSupplier recheckAllErrors, IInputHandler<@NotNull ItemStack> itemInputHandler,
        ...
        return new MSTwoInputCachedRecipe<>(recipe, recheckAllErrors, itemInputHandler, chemicalInputHandler, outputHandler, recipe::getItemInput, recipe::getChemicalInput,
     ...
     * @since 10.7.0
     */
    public static <RECIPE extends RadiationIrradiatingRecipe> MSTwoInputCachedRecipe<@NotNull ItemStack, @NotNull ChemicalStack, @NotNull ChemicalStack, RECIPE>
     ...
     * @param outputHandler     Output handler.
     */
    public static MSTwoInputCachedRecipe<@NotNull ItemStack, @NotNull ItemStack, @NotNull ItemStack, CombinerRecipe> combiner(CombinerRecipe recipe,
        ...
        return new MSTwoInputCachedRecipe<>(recipe, recheckAllErrors, inputHandler, extraInputHandler, outputHandler, recipe::getMainInput, recipe::getExtraInput,
