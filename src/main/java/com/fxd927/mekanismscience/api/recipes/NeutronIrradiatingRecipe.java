...
public abstract class NeutronIrradiatingRecipe extends MekanismRecipe implements BiPredicate<@NotNull ItemStack, @NotNull GasStack> {
     ...
     * @param output    Output.
     */
    public NeutronIrradiatingRecipe(ResourceLocation id, ItemStackIngredient itemInput, ChemicalStackIngredient.GasStackIngredient gasInput, ChemicalStack<?> output) {
        super(id);
