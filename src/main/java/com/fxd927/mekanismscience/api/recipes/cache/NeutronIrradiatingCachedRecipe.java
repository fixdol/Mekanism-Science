...
public class NeutronIrradiatingCachedRecipe extends CachedRecipe<NeutronIrradiatingRecipe> {
     ...
     */
    public NeutronIrradiatingCachedRecipe(NeutronIrradiatingRecipe recipe, BooleanSupplier recheckAllErrors, IInputHandler<@NotNull ItemStack> itemInputHandler,
