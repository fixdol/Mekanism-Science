...
public class NeutronIrradiatorRecipeSerializer<RECIPE extends NeutronIrradiatingRecipe> implements RecipeSerializer<RECIPE> {
    private final NeutronIrradiatorRecipeSerializer.IFactory<RECIPE> factory;

    public NeutronIrradiatorRecipeSerializer(NeutronIrradiatorRecipeSerializer.IFactory<RECIPE> factory) {
    ...
    @FunctionalInterface
    public interface IFactory<RECIPE extends NeutronIrradiatingRecipe> {
