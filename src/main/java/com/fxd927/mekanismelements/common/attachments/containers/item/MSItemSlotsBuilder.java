package com.fxd927.mekanismelements.common.attachments.containers.item;
...
public class MSItemSlotsBuilder {
    ...
    private static final IBasicContainerCreator<ComponentBackedInventorySlot> BASIC_SLOT_CREATOR = (type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo,
            containerIndex, (stack, automationType) -> true, (stack, automationType) -> true, stack -> true);
    private static final IBasicContainerCreator<ComponentBackedInventorySlot> BASIC_INPUT_SLOT_CREATOR = (type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo,
            containerIndex, (stack, automationType) -> automationType != AutomationType.EXTERNAL, (stack, automationType) -> true, stack -> true);
    private static final IBasicContainerCreator<ComponentBackedInventorySlot> OUTPUT_SLOT_CREATOR = (type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo,
            containerIndex, (stack, automationType) -> true, (stack, automationType) -> automationType == AutomationType.INTERNAL, stack -> true);
    ...
    private static final IBasicContainerCreator<ComponentBackedInventorySlot> FUEL_SLOT_CREATOR = (type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo,
            containerIndex, FUEL_CAN_EXTRACT, FUEL_CAN_INSERT, stack -> true);
    ...
    private static final IBasicContainerCreator<ComponentBackedInventorySlot> FORMULA_SLOT_CREATOR = (type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo,
            containerIndex, (stack, automationType) -> true, (stack, automationType) -> true, TileEntityFormulaicAssemblicator.FORMULA_SLOT_VALIDATOR);
    ...
    private static final IBasicContainerCreator<ComponentBackedInventorySlot> QIO_DRIVE_SLOT_CREATOR = (type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo,
            containerIndex, (stack, automationType) -> automationType != AutomationType.EXTERNAL, (stack, automationType) -> automationType != AutomationType.EXTERNAL, QIODriveSlot.IS_QIO_ITEM);
    ...
    private static final IBasicContainerCreator<ComponentBackedInventorySlot> QIO_DASHBOARD_OUTPUT_SLOT_CREATOR = (type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo,
            containerIndex, (stack, automationType) -> automationType == AutomationType.INTERNAL, (stack, automationType) -> automationType == AutomationType.INTERNAL, stack -> true);
    ...
    public MSItemSlotsBuilder addBasicFactorySlots(int process, Predicate<ItemStack> recipeInputPredicate) {
    ...
    public MSItemSlotsBuilder addBasicFactorySlots(int process, Predicate<ItemStack> recipeInputPredicate, boolean secondaryOutput) {
        IBasicContainerCreator<ComponentBackedInventorySlot> inputSlotCreator = (type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo, containerIndex,
                (stack, automationType) -> automationType != AutomationType.EXTERNAL, (stack, automationType) -> true, recipeInputPredicate);
    ...
    public MSItemSlotsBuilder addSlots(int count, IBasicContainerCreator<? extends ComponentBackedInventorySlot> creator) {
    ...
    public MSItemSlotsBuilder addQIODriveSlots(int count) {
        return addSlots(count, QIO_DRIVE_SLOT_CREATOR);
    }

    public MSItemSlotsBuilder addQIODashboardSlots() {
    ...
    public MSItemSlotsBuilder addMinerSlots(int count) {
    ...
    public MSItemSlotsBuilder addFormulaCraftingSlot(int count) {
        return addSlots(count, (type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo, containerIndex, (stack, automationType) -> true,
                (stack, automationType) -> automationType == AutomationType.INTERNAL || !attachedTo.getOrDefault(MekanismDataComponents.AUTO, false), stack -> false));
    }
    ...
    public MSItemSlotsBuilder addUnlockSlot() {
    ...
    public MSItemSlotsBuilder addSlot(IBasicContainerCreator<? extends ComponentBackedInventorySlot> slot) {
        slotCreators.add(slot);
        return this;
    }

    public MSItemSlotsBuilder addFuelSlot() {
        return addSlot(FUEL_SLOT_CREATOR);
    }

    public MSItemSlotsBuilder addOredictionificatorInput() {
        return addSlot((type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo, containerIndex, (stack, automationType) -> automationType != AutomationType.EXTERNAL, (stack, automationType) -> true,
    ...
    public MSItemSlotsBuilder addOutput() {
        return addSlot(OUTPUT_SLOT_CREATOR);
    }

    public MSItemSlotsBuilder addOutput(int count) {
        return addSlots(count, OUTPUT_SLOT_CREATOR);
    }

    public MSItemSlotsBuilder addBasic(int count) {
        return addSlots(count, BASIC_SLOT_CREATOR);
    }

    public MSItemSlotsBuilder addInput(int count) {
        return addSlots(count, BASIC_INPUT_SLOT_CREATOR);
    }

    public MSItemSlotsBuilder addInput(Predicate<@NotNull ItemStack> isItemValid) {
        return addSlot((type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo, containerIndex, (stack, automationType) -> automationType != AutomationType.EXTERNAL, (stack, automationType) -> true, isItemValid));
    }
    ...
    public <VANILLA_INPUT extends RecipeInput, RECIPE extends MekanismRecipe<VANILLA_INPUT>, INPUT_CACHE extends IInputRecipeCache> MSItemSlotsBuilder addInput(
            IMSRecipeTypeProvider<VANILLA_INPUT, RECIPE, INPUT_CACHE> recipeType, ContainsRecipe<INPUT_CACHE, ItemStack> containsRecipe) {
        return addInput(stack -> containsRecipe.check(recipeType.getInputCache(), null, stack));
    }

    public MSItemSlotsBuilder addEnergy() {
        return addSlot(FILL_CONVERT_ENERGY_SLOT_CREATOR);
    }

    public MSItemSlotsBuilder addDrainEnergy() {
    ...
    public MSItemSlotsBuilder addFluidFillSlot(int tankIndex) {
        return addSlot(((type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo, containerIndex, (stack, automationType) -> automationType == AutomationType.MANUAL,
                (stack, automationType) -> canFluidFill(attachedTo, tankIndex, stack), stack -> true)));
    }

    public MSItemSlotsBuilder addFluidDrainSlot(int tankIndex) {
        return addSlot(((type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo, containerIndex, (stack, automationType) -> automationType == AutomationType.MANUAL, (stack, automationType) -> {
    ...
    public MSItemSlotsBuilder addFluidFuelSlot(int tankIndex, Predicate<@NotNull ItemStack> hasFuelValue) {
        ...
        }, (stack, automationType) -> hasFuelValue.test(stack) || canFluidFill(attachedTo, tankIndex, stack), stack -> true)));
    }
    ...
    public MSItemSlotsBuilder addChemicalFillSlot(int tankIndex) {
        return addSlot(((type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo, containerIndex,
                ...
                (stack, automationType) -> canChemicalFillInsert(attachedTo, tankIndex, stack), stack -> true)));
    }
    ...
    public MSItemSlotsBuilder addChemicalFillOrConvertSlot(int tankIndex) {
        return addSlot(((type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo, containerIndex,
                ...
                (stack, automationType) -> canChemicalFillOrConvertInsert(attachedTo, tankIndex, stack), stack -> true)));
    }
    ...
    public MSItemSlotsBuilder addChemicalDrainSlot(int tankIndex) {
        return addSlot(((type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo, containerIndex,
                ...
                (stack, automationType) -> canChemicalDrainInsert(attachedTo, tankIndex, stack), stack -> true)));
    }
