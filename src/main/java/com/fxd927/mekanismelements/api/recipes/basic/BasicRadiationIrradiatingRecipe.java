package com.fxd927.mekanismelements.api.recipes.basic;
...
public class BasicRadiationIrradiatingRecipe extends RadiationIrradiatingRecipe {
     ...
     */
    public BasicRadiationIrradiatingRecipe(ItemStackIngredient itemInput, ChemicalStackIngredient chemicalInput, ChemicalStack output, boolean perTickUsage) {
    ...
    @Override
    public RecipeSerializer<BasicRadiationIrradiatingRecipe> getSerializer() {
        return MSRecipeSerializers.RADIATION_IRRADIATING.get();
    }
}
