...
public abstract class RadiationIrradiatingRecipe extends ItemStackChemicalToObjectRecipe<ChemicalStack> {
    private static final Holder<Item> RADIATION_IRRADIATOR = DeferredHolder.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(MekanismElements.MODID, "radiation_irradiator"));
