...
public abstract class AdsorptionRecipe extends ItemStackChemicalToObjectRecipe<ChemicalStack> {
    private static final Holder<Item> ADSORPTION = DeferredHolder.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(MekanismElements.MODID, "adsorption"));
