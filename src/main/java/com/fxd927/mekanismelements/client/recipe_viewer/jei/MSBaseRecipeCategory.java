package com.fxd927.mekanismelements.client.recipe_viewer.jei;

import com.fxd927.mekanismelements.client.MSJEI;
import com.fxd927.mekanismelements.client.gui.element.progress.MSGuiProgress;
import com.fxd927.mekanismelements.client.recipe_viewer.MSRecipeViewerUtils;
...
public abstract class MSBaseRecipeCategory <RECIPE> extends AbstractContainerEventHandler implements IRecipeCategory<RECIPE>, IGuiWrapper {
    ...
    protected MSBaseRecipeCategory(IGuiHelper helper, RecipeType<RECIPE> recipeType, Component component, IDrawable icon, int xOffset, int yOffset, int width, int height) {
